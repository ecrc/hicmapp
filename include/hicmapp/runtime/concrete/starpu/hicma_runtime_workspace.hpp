 ...
 *
 */
#ifndef _HICMA_STARPU_WORKSPACE_H_
#define _HICMA_STARPU_WORKSPACE_H_
 ...
 */
int   HICMA_RUNTIME_starpu_ws_alloc   ( HICMA_starpu_ws_t **workspace, size_t size, int which_workers, size_t memory_location);
...
#endif /* _HICMA_STARPU_WORKSPACE_H_ */
